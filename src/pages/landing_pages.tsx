  ...
  return (
    <div className="tw-sm:absolute tw-top-0 tw-z-1 tw-h-fit	">
      <div className="tw-relative tw-flex-col tw-sm:flex tw-sm:flex-row-reverse">
        <img
          className="tw-relative tw-sm:top-24 tw-md:top-12 w-60 tw-m-auto tw-sm:w-1/2  tw-sm:m-0"
          src={backgroundImage}
        />

        <div className="tw-relative tw-flex-col tw-text-center tw-sm:text-left tw-sm:top-24 tw-md:top-40 tw-sm:left-6">
          <h1 className="tw-font-title-font tw-text-4xl tw-md:text-6xl tw-text-secondary-color">
            Get Your Invoice Templates
          </h1>
          <br />

          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia vitae
            soluta eveniet amet molestias .
          </p>
          <br />

          <Link to="/generate-invoice">
            <button className="tw-py-2.5 tw-px-3.5 tw-w-48 tw-rounded-xl tw-bg-secondary-color tw-text-primary-font-color">
              Create Invoice Now
            </button>
          </Link>
          <br />
          ...
          <div className="tw-flex tw-justify-center tw-sm:flex tw-sm:justify-start">
            <GoogleLogin
              ...
              render={(renderProps) => (
                <>
                  <button
                    className="tw-bg-black tw-text-white tw-py-2.5 tw-px-3.5 tw-w-36 tw-mr-4"
