...
const Img = ({pdfMode, src,}: any) => {
  return (
    // @ts-ignore
    pdfMode ? <Image style={{ width: '16px', height: '16px', maxWidth: '16px'}} src={src} /> : <img width={16} className="image__img" src={src} />
    // <Image src={src}/>
  )
}

const Contact = ({ pdfMode, onChange, className, style, data }: ContactProps) => {
  ...
  return (
    <VStack pdfMode={pdfMode} spacing={4} className={className} style={style}>
        ...
        {/* @ts-ignore */}
        <HStack pdfMode={pdfMode} crossAxisAlignment="center" className="w-100" spacing={8}>
            <Img pdfMode={pdfMode} src={emailImage}/>
            <EditableInput pdfMode={pdfMode} value={customContact.email} onChange={(value) => {
              setCustomContact({
                ...customContact,
                email: value
              })
        ...
        <HStack pdfMode={pdfMode} crossAxisAlignment="center" className="w-100" spacing={8}>
            ...
            <EditableInput pdfMode={pdfMode} value={customContact.phone} onChange={(value) => {
              setCustomContact({
                ...customContact,
                phone: value
              })
        ...
        <HStack pdfMode={pdfMode} crossAxisAlignment="center" className="w-100" spacing={8}>
            ...
            <EditableInput pdfMode={pdfMode} value={customContact.address} onChange={(value) => {
              setCustomContact({
                ...customContact,
                address: value
              })
        ...
        <HStack pdfMode={pdfMode} crossAxisAlignment="center" className="w-100" spacing={8}>
            ...
            <EditableInput pdfMode={pdfMode} value={customContact.website} onChange={(value) => {
              setCustomContact({
                ...customContact,
                website: value
              })
