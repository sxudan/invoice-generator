...
const PurchaseOrderPage: FC<Props> = ({
  ...
  const [invoice, setInvoice] = useState<PurchaseOrder>(
    data ? { ...data } : { ...initialPurchaseOrderData },
  );
    ...
    return (
      <Document pdfMode={pdfMode}>
        <Page className="invoice-wrapper" pdfMode={pdfMode}>
          ...
          <View className="flex" pdfMode={pdfMode}>
            ...
            <View className="w-50 mt-20" pdfMode={pdfMode}>
              ...
              <View
                ...
                pdfMode={pdfMode}
                // @ts-ignore
                style={{ backgroundColor: dim(theme.primaryColor) }}
              >
                <View className="w-50 p-5" pdfMode={pdfMode}>
                  <EditableInput
                    className="bold"
          ...
          {!premium && (
            <View className="watermark mt-40 right" pdfMode={pdfMode}>
